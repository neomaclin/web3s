...
trait Admin[F[_]]:
  ...
  def personalUnlockAccount(address: String, passphrase: String, duration: BigInt): F[PersonalUnlockAccount]

  def personalUnlockAccount(address: String, passphrase: String): F[PersonalUnlockAccount]
